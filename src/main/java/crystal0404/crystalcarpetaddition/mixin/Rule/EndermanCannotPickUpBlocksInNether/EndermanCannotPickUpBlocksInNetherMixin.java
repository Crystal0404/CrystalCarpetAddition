...
package crystal0404.crystalcarpetaddition.mixin.Rule.EndermanCannotPickUpBlocksInNether;
...
public abstract class EndermanCannotPickUpBlocksInNetherMixin {

    @ModifyExpressionValue(
            method = "tick",
            at = @At(value = "INVOKE", target = "Lnet/minecraft/block/BlockState;isIn(Lnet/minecraft/registry/tag/TagKey;)Z")
    )
    private boolean pickUpTickMixin(boolean original, @Local World world) {
